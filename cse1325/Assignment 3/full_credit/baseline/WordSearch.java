...
public class WordSearch {
    ...
    public void solve() {
        ...
        for (int i=0; i<NUM_THREADS; ++i)
        {
            ...
            final int firstPuzzle = threadID * puzzlesPerThread;
            final int lastPuzzle = (threadID == NUM_THREADS - 1) ? NUM_PUZZLES : (firstPuzzle + puzzlesPerThread);
    
            Thread thread = new Thread(() -> solve(threadID, firstPuzzle, lastPuzzle));
            threads.add(thread);
            thread.start();
        }
